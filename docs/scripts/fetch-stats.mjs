...
const statsUrl =
  process.env.STATS_URL || 'https://wasl-production-05b9.up.railway.app/api/stats';
const outPath = path.join(docsDir, 'stats.json');
...
try {
  ...
  console.warn('fetch-stats: skipped —', err.message);
  process.exit(0);
}
